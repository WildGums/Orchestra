    ...
    public class RecentlyUsedItemsService : IRecentlyUsedItemsService
    {
        ...
        private void Load()
        {
            ...
            try
            {
                ...
                {
                    _logger.LogInformation("No recently used items found");
                    return;
                }
            ...
            {
                _logger.LogError(ex, "Failed to load recently used items");
            }
        }
        ...
        private void Save()
        {
            ...
            {
                _logger.LogError(ex, "Failed to save recently used items");
            }
        }
    }
}
